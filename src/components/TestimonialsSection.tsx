  ...
  const testimonials = [
    {
      ...
      testimonial: `Eu não tinha experiência nenhuma e achava que nunca ia conseguir um emprego aqui em São José dos Campos. Em 3 meses depois do certificado, fui contratada!`,
    ...
    },
    {
      ...
      age: 45,
      city: 'Florianópolis',
      course: "Auxiliar de Contabilidade",
      testimonial: `Meu filho estava perdido. Hoje ele faz estágio em uma empresa grande aqui de Florianópolis e já ajuda nas contas de casa. Sou muito grata!`,
    ...
    },
    {
      ...
      testimonial: `Saí do desemprego e hoje tenho minha própria barbearia! Sou muito conhecido aqui em Barbacena graças ao curso.`,
    ...
    },
    {
      ...
      testimonial: "Hoje atendo em domicílio aqui em João Neves e ganho mais do que ganhava no meu emprego anterior! Foi a melhor decisão.",
    ...
    },
    {
      ...
      city: 'Manacapuru',
      course: "Informática",
      testimonial: `Minha filha conseguiu uma vaga excelente aqui em Manacapuru. Como pai, não tenho palavras para agradecer a oportunidade.`,
